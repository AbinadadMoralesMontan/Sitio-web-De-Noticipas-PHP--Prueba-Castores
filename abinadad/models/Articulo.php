<?php
    ...
    class Articulo{
        ...
        public function leer_individual($id){
            //Crear query
            $query = 'SELECT id, titulo, imagen, texto, fecha_creacion, id_usuario FROM ' . $this->table . ' WHERE id = ? LIMIT 0,1';
        ...
        //Crear un artículo
        public function crear($titulo, $newImageName, $texto, $idPublicador){
            //Crear query
            $query = 'INSERT INTO ' . $this->table . ' (titulo, imagen, texto, id_usuario)VALUES(:titulo, :imagen, :texto, :id_usuario)';
            ...
            $stmt->bindParam(":id_usuario", $idPublicador);
