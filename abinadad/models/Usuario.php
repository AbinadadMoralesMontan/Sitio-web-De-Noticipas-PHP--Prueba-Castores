<?php
    class Usuario{
        ...
        //Registrarse
        public function registrar($nombre, $email, $password, $apepaterno, $apematerno){
            //Crear query
            ...
            if ($stmt->execute()) {
                ...
                $queryPersonal = 'INSERT INTO personal  (nombre, apepaterno, apematerno, idusuario)VALUES(:nombre, :apepaterno, :apematerno, :idusuario)';
                $stmtPersonal = $this->conn->prepare($queryPersonal);
                
                $stmtPersonal->bindParam(":nombre", $nombre, PDO::PARAM_STR);
                $stmtPersonal->bindParam(":apepaterno", $apepaterno, PDO::PARAM_STR);
                $stmtPersonal->bindParam(":apematerno", $apematerno, PDO::PARAM_STR);                
                $stmtPersonal->bindParam(":idusuario", $last_id, PDO::PARAM_STR);
