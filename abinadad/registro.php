        ...
        if (empty($nombre) || $nombre == '' || empty($email) || $email == '' || empty($password) || $password == '' || empty($confirmarPassword) || $confirmarPassword == '') {
            ...
            if ($password != $confirmarPassword) {
                ...
                if ($usuario->validar_email($email)) {
                    ...
                    if ($usuario->registrar($nombre, $email, $password, $apepaterno, $apematerno)) {
                ...
                <div class="card">
                   <div class="card-header">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="apepaterno" placeholder="Ingresa el apellido paterno">               
                    </div>

                    <div class="mb-3">
                        <label for="apematerno" class="form-label">Apellido Materno:</label>
                        <input type="text" class="form-control" name="apematerno" placeholder="Ingresa el apellido materno">               
                    </div>
