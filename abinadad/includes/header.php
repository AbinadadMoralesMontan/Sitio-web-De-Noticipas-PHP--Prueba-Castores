...
<?php
  ...
  session_start();
  //Si no existe la sesión lo devolvemos
...
<html lang="es">
  <head>
    ...
    <title>Abinadad Morales Montan</title>
  </head>
  <body>
    
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="<?php echo RUTA_FRONT; ?>">Abinadad Morales Montan</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <?php if(isset($_SESSION['autenticado'])) : ?>
                    <?php foreach($resultado as $usuario) : ?>
                        <?php if($usuario->usuario_email == $_SESSION['email'] && $usuario->usuario_email=='Interno') : ?>
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Administración
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li>
                                        <a class="dropdown-item" href="<?php echo RUTA_ADMIN; ?>articulos.php">Noticias</a>
                                        </li>
                                        <li>
